...
jp_feature_names_list = \
 ['がく片の長さ [cm]', 'がく片の幅 [cm]', '花びらの長さ [cm]', '花びらの幅 [cm]']
jp_target_names_array = np.array(['セトサ種', 'バージカラー種', 'バージニカ種'])
iris.feature_names = jp_feature_names_list
iris.target_names  = jp_target_names_array
